...
SearchBuses.post("/api/searchbuses", userAuth, async (req, res) => {
    try {
        ...
        BusesInRoute.forEach( (bus) => {
            ...
            let bookingsForBus = bookingsForDate.buses.find(booking => booking.BusNumber === bus.busNumber);
            ...
            if (!bookingsForBus) {
                ...
                bus.bookings = {
                    ...
                    seatsSelected: bookingsForBus.seatsSelected.map(seat => seat.seatNumber),
